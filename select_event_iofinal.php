            ...
            <div class="row mt">
              ...
              <div class="form-group">
                                               <div class="btn-group btn-group-justified">
                                                 <div class="btn-group">
                                                  <div class="col-sm-8">
                                                  <button class="btn btn-theme02" type="button"><a href="select_event_iofinal.php?action=sen">Search event by name</a></button>
                                                </div>
                                               </div>
                                               <div class="btn-group">
                                                <div class="col-sm-8">
                                                  <button class="btn btn-theme03" type="button"><a href="select_event_iofinal.php?action=seda">Search event by date</a></button>
                                                </div>
                                              </div>
                                                
                                                <div class="btn-group">
                                                <div class="col-sm-8">
                                                  <button class="btn btn-theme02" type="button"><a href="select_event_iofinal.php?action=sede">Search event by department</a></button>
                                                </div>
                                              </div>
...
{
  ?>
  <form class="form-horizontal style-form" action="select_event_iofinal.php?action=sen" method="POST" class="form-group">
  ...
  if(isset($_POST['search_event1']))
  {
    ...
    $query1=mysqli_query($connect,"SELECT * FROM event where E_name='".$search_event_name."' and event_status ='Approved'");
    ?>
     <div class="row mt mb">
                  <div class="col-md-12">
      ...
      ?>
        <li>
                                          ...
                                          <div class="task-title">
                                            ...
                                            <button onclick="location.href = 'search_event_iofinal.php?id=<?php echo $search_event_id; ?>';" class="btn btn-primary btn-xs fas fa-eye"></button>
...
if(@$_GET['action']=='seda') {
  ?>
    <form class="form-horizontal style-form" action="select_event_iofinal.php?action=seda" method="POST">
    <br>
    <div class="form-group">
  ...
  if(isset($_POST['search_event2']))
  {
    ...
    $query2=mysqli_query($connect,"SELECT * FROM event where Event_date BETWEEN '".$event_date_from."' AND '".$event_date_to."'  AND event_status ='Approved'");
    ?>
    <div class="row mt mb">
                  <div class="col-md-12">
                      <section class="task-panel tasks-widget">
...
{
  ?>
  <form class="form-horizontal style-form" action="select_event_iofinal.php?action=sede" method="POST">
    <br>
                              <div class="form-group">
  ...
  if(isset($_POST['search_event3']))
  {
    ...
    $query4=mysqli_query($connect,"SELECT * FROM event where Department like '%".$search_event_dept."%' AND event_status ='Approved'");
    ?>
    ...
    while ($row4=mysqli_fetch_array($query4)) {
      ...
      ?>
                    ...
                    <br>
      <!--<a href="search_event_iofinal.php?id= //echo $search_event_id; ?>" $event_name; ?></a>-->
      <?php
    }
    ?>
