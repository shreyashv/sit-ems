                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="update_event.php?id=<?php echo $edit_event_id; ?>" method="POST" enctype="multipart/form-data">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <?php echo("<input value='".$event_name."' type='text' class='form-control' id='Name of the event' name='event_name' required>");?>
                              </div>
                                </div>
  ...
  ?>
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Date of the Event</label>
                                      <div class="col-sm-10">
                                      <?php echo("<input type='date' value='".$event_date."' name='event_date' max='".$today_date."'>");
          ?>
                                  </div>
                                  </div>
      ...
      ?>
                                        ...
                                        <input type="button" name="add_new_res" id="add_new_res" value="Add Resource">
                                          ...
                                          <label class="col-sm-2 col-sm-2 control-label">A paragraph describing for the event/ activity</label>
                                              <div class="col-sm-10">
                                                  <?php echo("<input value='".$description."' class='form-control' id='Name of the event' type='text' name='description' required>");
          ?>
                                              </div>                                           
                                         </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php echo("<input class='form-control' value='".$achievments."' id='Name of the event' type='text' name='achievements' required>");
          ?>
                                                </div> 
