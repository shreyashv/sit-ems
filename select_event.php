...
<section id="main-content">
          <section class="wrapper">
              ...
              <div class="form-group">
                                  ...
                                  <div class="btn-group">
                                                <div class="col-sm-8">
                                                  <button class="btn btn-theme02" type="button"><a href="select_event.php?action=sen">Search event by name</a></button>
                                                </div>
                                            </div>
                                                <div class="btn-group">
                                                <div class="col-sm-8">
                                                  <button class="btn btn-theme03" type="button"><a href="select_event.php?action=seda">Search event by date</a></button>
                                                </div>
                                                </div>
                                                <div class="btn-group">
                                                <div class="col-sm-8">
                                                  <button class="btn btn-theme04" type="button"><a href="select_event.php?action=sede">Search event by department</a></button>
                                                </div>
                                            </div>
</div>
                                       </div>
...
{
	?>
 <form class="form-horizontal style-form" action="select_event.php?action=sen" method="POST" class="form-group">
     <br>
                              <div class="form-group">
...
if(@$_GET['action']=='seda') {
	?>
     <form class="form-horizontal style-form" action="select_event.php?action=seda" method="POST">
    <br>
    <div class="form-group">
...
{
	?>
 <form class="form-horizontal style-form" action="select_event.php?action=sede" method="POST">
     <br>
                              <div class="form-group">
